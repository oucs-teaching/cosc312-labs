---
title: COSC312 Lab 12—Rust and CHERI machine code
tags: [cosc312, lab]

---

# COSC312 Lab 12—Rust and CHERI machine code
...
- You can test that the default Rust application works using the command `cargo run` in the directory that contains the `Cargo.toml` file.
